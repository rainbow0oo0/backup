std_no        insert into ( )values 미포함 >> 자동생성
 std_jumin    주민
 std_name    학생이름
 std_eng_name    영문명    필수x
 std_gen        성별
...
/////////////////////////////
 ...
 std_dep_no     FK(보고 넣으면됨)
 std_pro_no     FK
 std_seq          insert into ( )values 미포함
 std_ent          연도 ex)2024

insert into student (std_jumin, std_name, std_eng_name, std_gen, std_dep_no, std_pro_no, std_ent) value

-- department table
insert into department values(1, '인문대학', '국문학과', '김국어', '051-512-1001', 21, 101, 10);
insert into department values(2, '인문대학', '영어영문학과', '김영어', '051-512-1002', 22, 102, 10);
insert into department values(3, '인문대학', '윤리학과', '김윤리', '051-512-1003', 23, 102, 11);
insert into department values(4, '사회과학대학', '사회학과', '김사회', '051-512-1004', 24, 104, 11);
insert into department values(5, '사회과학대학', '경제학과', '김경제', '051-512-1005', 25, 105, 12);
insert into department values(6, '경영대학', '기계공학과', '김기계', '051-512-1006', 26, 106, 12);
insert into department values(7, '경영대학', '컴퓨터공학과', '김컴공', '051-512-1007', 27, 107, 13);
insert into department values(8, '자연과학대학', '물리학과', '김물리', '051-512-1008', 28, 108, 13);
insert into department values(9, '자연과학대학', '화학과', '김과학', '051-512-1009', 29, 109, 14);
insert into department values(10, '정보과학대학', '컴퓨터공학과', '김컴공', '051-512-1010', 30, 110, 14);
insert into department values(11,'정보과학대학', '기계공학', '김기계', '051-512-1011', 31, 111, 15);
...
create table notice (
    ...
    setN_content   VARCHAR2(50)   DEFAULT '담당자',       -- 작성자
    setN_regdate   DATE           DEFAULT SYSDATE,       -- 작성일
    setN_views     NUMBER         DEFAULT 0              -- 조회수
);
